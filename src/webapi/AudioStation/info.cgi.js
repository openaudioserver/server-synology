...
const AudioStationInfoCGI2 = JSON.stringify({
  data: {
    ...
    same_subnet: true,
    serial_number: process.env.SYNOLOGY_SERIAL_NUMBER || '1130LWN011720',
    settings: {
    ...
    sid: `${process.env.SYNOLOGY_SESSION_ID || 'ap0hulniOX5f'}.${process.env.SYNOLOGY_SERIAL_NUMBER || '1130LWN011720'}`,
