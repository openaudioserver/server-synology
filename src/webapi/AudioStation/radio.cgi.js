...
async function listFavoriteStations (library) {
  const response = {
    data: {
...
async function listSHOUTcastGenres (library) {
  const response = {
    data: {
...
async function listSHOUTCastGenreStations (library, options) {
...
async function addStation (library, options) {
...
async function updateStation (library, options) {
