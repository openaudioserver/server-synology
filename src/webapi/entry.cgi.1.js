_SYNOINFODEF = {
  ...
  ftp_pasv_def_min_port: '55536',
  usbcopy: 'no',
  max_sdr_replica: '64',
  mem_max_mb: '32768',
  ftp_pasv_def_max_port: '56559',
  ...
  vender: 'Synology Inc.',
  ftp_trans_ext_ip: 'no',
  online_help_base_url: 'http://www.synology.com/',
  ...
  supportmysql: 'yes',
  printer_driver_host: 'https://download.synology.com/airprint/DSM6.0/latest',
  ftpflowcontrol: 'no',
  supportssh: 'yes',
  ...
  supportitunes: 'yes'
}; function _D (s, d) { if (s in _SYNOINFODEF) { return _SYNOINFODEF[s] } else if (typeof d === 'string') { return d } return '' }
